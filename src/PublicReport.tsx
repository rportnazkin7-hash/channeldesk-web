  ...
  return <main className="public-report-page">
    <section className="public-report-shell">
      ...
      <div className="public-report-list">
        {report.bookings.length === 0 ? <div className="public-report-empty">Размещений пока нет.</div> : report.bookings.map(booking => <article className="public-booking" key={booking.id}>
